...
// 1. Add the new subtab button
const oldTabs = `            <button class="btn btn-secondary subtab-btn" data-subtab="keigo">敬語系統對照</button>
          </div>`;
const newTabs = `            <button class="btn btn-secondary subtab-btn" data-subtab="keigo">敬語系統對照</button>
            <button class="btn btn-secondary subtab-btn" data-subtab="tenses">四大詞性時態對照</button>
          </div>`;

html = html.replace(oldTabs, newTabs);

// 2. Add the new subtab-tenses-view right before the end of the consolidation-page
// The consolidation-page ends before <section id="grammar-page"
const grammarPageStart = '<section id="grammar-page" class="page-section hide">';
...
html = html.replace('</div>\n        </section>\n\n        <!-- ========================================= -->\n        <!-- PAGE 3: 文法核心庫 (Grammar Core)         -->', tensesViewHTML + '\n        <!-- ========================================= -->\n        <!-- PAGE 3: 文法核心庫 (Grammar Core)         -->');

fs.writeFileSync('index.html', html, 'utf8');
console.log('Successfully patched index.html with Tenses matrix.');
