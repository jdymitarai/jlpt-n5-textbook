...
// Insert Button
const buttonSearch = '<button class="btn btn-secondary subtab-btn" data-subtab="keigo">敬語系統對照</button>\n          </div>';
if (html.includes(buttonSearch)) {
  html = html.replace(buttonSearch, '<button class="btn btn-secondary subtab-btn" data-subtab="keigo">敬語系統對照</button>\n            <button class="btn btn-secondary subtab-btn" data-subtab="tenses">四大詞性時態對照</button>\n          </div>');
...
// Insert View
const viewSearch = `              <div id="keigo-container"></div>
            </div>
          </div>
        </section>`;

if (html.includes(viewSearch)) {
  ...
  html = html.replace(viewSearch, `              <div id="keigo-container"></div>
            </div>
${tensesViewHTML}
          </div>
        </section>`);
