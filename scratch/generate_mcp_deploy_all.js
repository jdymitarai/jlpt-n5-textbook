...
const code = `async () => {
  ...
  for (const file of files) {
    console.log("Uploading " + file.name + " to R2 (" + (file.b64.length * 0.75 / 1024).toFixed(1) + " KB)...");
...
const outPath = path.join(srcDir, 'mcp_deploy_all_code.txt');
fs.writeFileSync(outPath, code, 'utf8');
console.log("Successfully generated mcp_deploy_all_code.txt!");
