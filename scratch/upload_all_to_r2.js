...
// Copy index.html and app.js to public/ first to ensure they are synchronized
fs.copyFileSync(path.join(srcDir, 'index.html'), path.join(publicDir, 'index.html'));
fs.copyFileSync(path.join(srcDir, 'app.js'), path.join(publicDir, 'app.js'));
fs.copyFileSync(path.join(srcDir, 'styles.css'), path.join(publicDir, 'styles.css'));
fs.copyFileSync(path.join(srcDir, 'data.js'), path.join(publicDir, 'data.js'));
console.log("Synchronized root assets to public/ folder");
...
async function run() {
  ...
  console.log("All files successfully uploaded to Cloudflare R2!");
}
